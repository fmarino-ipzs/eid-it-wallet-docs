...
- The Relying Party MUST expose an endpoint for the erasure of personal attributes presented by the Users whenever the requested attributes that can uniquely identify Users (e.g. the "Codice Fiscale" claim of the PID).
